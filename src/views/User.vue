<template>
  <div class="my-use">
    ...
    <my-navbar title="我的关注" content="关注的用户" @click="$router.push('/myfollow')"></my-navbar>
    <my-navbar title="我的跟帖" content="跟帖/回复" @click="$router.push('/mycomment')"></my-navbar>
    <my-navbar title="我的收藏" content="文章/视频" @click="$router.push('/my-star')"></my-navbar>
    <my-navbar title="去首页" @click="$router.push('/')"></my-navbar>
